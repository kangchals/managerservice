...
exports.init = function(container, callback) {
    ...
    container.addListener('CS_addNewService',CS_addNewService_managerJS);
    /*
...
function CS_addNewService_managerJS(req, res){

    exports.container.getRouteTable().add(req.body.serviceName , req.body.moduleName);
    exports.container.getRouteTable().setStatus(req.body.serviceName , 'off');

    var csCallback = function (){
        res.send( exports.container.getRouteTableJSON());
    };
    initNewService(csCallback);
}


function initNewService(callback) {
